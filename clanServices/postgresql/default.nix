...
{
  _class = "clan.service";
  manifest.name = "clan-core/postgresql";
  manifest.description = "A free and open-source relational database management system (RDBMS) emphasizing extensibility and SQL compliance.";
        ...
        nixosModule =
          ...
          in
          {
            ...
            environment.systemPackages = builtins.map (
              ...
              ''
            ) (builtins.attrValues settings.databases);
          };
      };
  };
}
